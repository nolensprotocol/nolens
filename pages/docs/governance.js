      ...
      <main className="min-h-screen bg-black text-white pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-white/60 mb-12">
            Governance at Nolens is about <strong>contribution, not speculation</strong>. We’re building a system that aligns with those who help — not those who hold.
          </p>
          ...
          <div className="space-y-10">
            ...
            <Card className="fade-in-up delay-200">
              <h2 className="text-2xl font-semibold mb-3">Reputation Through $NOL</h2>
              <p className="text-white/70 text-base leading-relaxed">
            ...
            <Card className="fade-in-up delay-400">
              <h2 className="text-2xl font-semibold mb-3">Long-Term Alignment</h2>
              <p className="text-white/70 text-base leading-relaxed">
